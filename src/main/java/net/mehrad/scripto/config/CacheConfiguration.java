package net.mehrad.scripto.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(net.mehrad.scripto.domain.User.class.getName(), jcacheConfiguration);
            cm.createCache(net.mehrad.scripto.domain.Authority.class.getName(), jcacheConfiguration);
            cm.createCache(net.mehrad.scripto.domain.User.class.getName() + ".authorities", jcacheConfiguration);
