package net.mehrad.scripto.config.social;

import net.mehrad.scripto.repository.SocialUserConnectionRepository;
import net.mehrad.scripto.repository.CustomSocialUsersConnectionRepository;
import net.mehrad.scripto.security.social.CustomSignInAdapter;
