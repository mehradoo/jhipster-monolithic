...
import net.mehrad.scripto.domain.PersistentToken;
...
import net.mehrad.scripto.security.SecurityUtils;
...
import net.mehrad.scripto.web.rest.vm.KeyAndPasswordVM;
import net.mehrad.scripto.web.rest.vm.ManagedUserVM;
import net.mehrad.scripto.web.rest.util.HeaderUtil;
