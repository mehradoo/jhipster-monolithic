...
import net.mehrad.scripto.domain.Job;
import net.mehrad.scripto.repository.JobRepository;
import net.mehrad.scripto.service.dto.JobDTO;
import net.mehrad.scripto.service.mapper.JobMapper;
