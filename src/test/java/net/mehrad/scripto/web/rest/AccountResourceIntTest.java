package net.mehrad.scripto.web.rest;

import net.mehrad.scripto.ScriptoApp;
import net.mehrad.scripto.domain.Authority;
import net.mehrad.scripto.domain.User;
import net.mehrad.scripto.repository.AuthorityRepository;
import net.mehrad.scripto.repository.PersistentTokenRepository;
import net.mehrad.scripto.repository.UserRepository;
import net.mehrad.scripto.security.AuthoritiesConstants;
import net.mehrad.scripto.service.MailService;
import net.mehrad.scripto.service.UserService;
import net.mehrad.scripto.service.dto.UserDTO;
import net.mehrad.scripto.web.rest.vm.ManagedUserVM;
...
@SpringBootTest(classes = ScriptoApp.class)
